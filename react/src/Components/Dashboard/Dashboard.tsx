...
const LearnMoreSection: React.FC = () => (
    <Row>
        <OutlinedColumn xs={12} md={6}>
            <Text>
                TooManyCellsInteractive is an interactive visualization tool
                allowing users to explore cell cluster trees generated by{' '}
                <ExternalLink
                    target='_blank'
            ...
            <Text>
                For a detailed visual introduction to TooManyCellsInteractive,
                please visit the tutorial on the{' '}
                <ExternalLink
                    target='_blank'
